...
ssh -t -oStrictHostKeyChecking=no -i $(pwd)/.deploy/travis_id_rsa travis@jersey1.rkeplin.com 'sed -i "s/image: rkeplin\/bible-angularjs-ui:[a-zA-Z0-9]*/image: rkeplin\/bible-angularjs-ui:'"$TRAVIS_BUILD_NUMBER"'/g" /opt/stacks/bible.yml'
